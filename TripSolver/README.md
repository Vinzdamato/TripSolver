...
**Autore:** Vincenzo D'Amato - 804738 | **Corso:** Ingegneria della Conoscenza (Icon) - A.A. 2025/2026 | **Link GitHub:** [https://github.com/Vinzdamato/TripSolver.git](https://github.com/Vinzdamato/TripSolver.git)
...
3. Verificare che tutto funzioni correttamente:
   ...
   ```
   Esegue l'intera pipeline in sequenza e genera `verification_report.txt`, segnalando quale reasoner OWL viene effettivamente usato (Pellet o HermiT) e confermando che tutti gli script girano senza errori.
4. Eseguire la pipeline, in ordine:
   ```bash
