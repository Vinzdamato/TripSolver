...
## 2. Argomenti del programma affrontati (da dichiarare esplicitamente in apertura della relazione)
...
- Documentare la differenza fra i vincoli "hard" (budget di tempo,
  copertura) e quelli che nello scaffold sono trattati come hard ma che
...
`AdattoMaltempo` già presente nello scaffold come evidenza osservabile
...
---
*Generato come base di lavoro: i contenuti tecnici (soglie, vincoli,
risultati) vanno verificati, ricalibrati e discussi criticamente con
dati reali prima della consegna — non vanno consegnati così come sono
nello scaffold.*
